...
const NetworkDns = lazy(() => import('Page/network/dns'));
			...
			<div className={classes.root}>
				...
				<div className={classes.app}>
					...
					<Suspense fallback={<div>Loading...</div>}>
						<Switch>
							{/* TODO: Should find a way to pass these into a switch wrapper, which will build the navigator... or too much work? */}
